...
y = numpy.linspace(-110.0, 110.0, 500)
gn = Triangle(-100.0, -80.0, -60.0)(y)
pn = Triangle(-80.0, -60.0, 0.0)(y)
z = Triangle(-60.0, 0.0, 60.0)(y)
pp = Triangle(0.0, 60.0, 80.0)(y)
gp = Triangle(60.0, 80.0, 100.0)(y)
...
try:
    ...
    a1.set_xlim([ -30, 30 ])
    a1.set_ylim([ -0.1, 1.1 ])
    a1.set_xticks(linspace(-100, 100, 7.0))
